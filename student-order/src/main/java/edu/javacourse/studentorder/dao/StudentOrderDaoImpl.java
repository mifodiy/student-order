...
public class StudentOrderDaoImpl implements StudentOrderDao
{
    ...
    private static final String INSERT_ORDER =
            "INSERT INTO jc_student_order(" +
                    ...
                    "h_sur_name, h_give_name, h_patronymic, h_date_of_birth, h_passport_seria, " +
    ...
    private static final String INSERT_CHILD =
            "INSERT INTO jc_student_child(" +
                    ...
                    "c_give_name, c_patronymic, c_date_of_birth, " +
    ...
    private static final String SELECT_ORDERS =
            "select so.*, ro.r_office_area_id, ro.r_office_name, " +
                    ...
                    "inner join jc_passport_office po_h on " +
                    "po_h.p_office_id = so.h_passport_office_id " +
                    "inner join jc_passport_office po_w on " +
                    "po_w.p_office_id = so.w_passport_office_id " +
    ...
    private static final String SELECT_ORDERS_FULL =
            "SELECT so.*, ro.r_office_area_id, ro.r_office_name, " +
                    ...
                    "INNER JOIN jc_passport_office po_w ON " +
                    "po_w.p_office_id = so.w_passport_office_id " +
                    "INNER JOIN jc_student_child soc ON " +
                    "soc.student_order_id = so.student_order_id " +
    ...
    private void setParamsForAdult(PreparedStatement stmt, int start, Adult adult) throws SQLException {
        ...
        stmt.setLong(start + 7, adult.getIssueDeparment().getOfficeId());
    ...
    private void setParamsForPerson(PreparedStatement stmt, int start, Person person) throws SQLException {
        ...
        stmt.setDate(start + 3, Date.valueOf(person.getDatOfBirth()));
    }
...
//        return getStudentOrdersTwoSelect();
    ...
    private Adult fillAdult(ResultSet rs, String pref) throws SQLException {
        ...
        adult.setGivenName(rs.getString(pref + "give_name"));
        adult.setPatronymic(rs.getString(pref + "patronymic"));
        adult.setDatOfBirth(rs.getDate(pref + "date_of_birth").toLocalDate());
    ...
    private Child fillChild(ResultSet rs) throws SQLException {
        ...
        String givenName = rs.getString("c_give_name");
